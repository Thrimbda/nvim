# orgmode-legion-e2e-parity-suite

## 目标

设计并落地一个端到端测试套件，覆盖 legion 原文的关键行为并验证当前实现与 orgmode/orgmode.nvim 语义一致。

## 要点

- 基于 Legion 原文提炼 MUST 行为并映射到可执行断言
...
- lua/org_punch.lua
- .legion/tasks/orgmode-legion-e2e-parity-suite/**
