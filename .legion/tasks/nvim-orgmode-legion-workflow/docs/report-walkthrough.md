# Walkthrough: Legion-style orgmode workflow (Neovim)

## Goal and Scope
- Goal: Implement a Legion-inspired orgmode workflow with custom agenda views and continuous clocking, plus repo-local documentation.
- Scope: `lua/plugins/orgmode.lua`, `lua/org_punch.lua`, `skills/legion-workflow/references/orgmode-legion-workflow.md`.
...
- `lua/plugins/orgmode.lua`
  - Add Legion-style agenda commands: block agenda, NEXT list, REFILE inbox.
...
## How to Verify
Reference: `/.legion/tasks/nvim-orgmode-legion-workflow/docs/test-report.md`.
...
- Non-blocking review suggestions noted in `/.legion/tasks/nvim-orgmode-legion-workflow/docs/review-code.md` (guarding missing clock actions, clarifying warnings) were not addressed in this change set.
