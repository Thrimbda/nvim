# Task Brief: Legion-style orgmode workflow for Neovim

## Problem
Design and implement a Legion-inspired workflow in Neovim (nvim-orgmode) that provides:
- Custom agenda views similar to Legion block agenda
