...
TITLE: 对齐审计 RFC（Norang / Task / Implementation）
SLUG: orgmode-norang-alignment-audit-rfc

## 目标

围绕用户问题“现有实现是否与 task 记录及 Norang 原文一致”产出可评审 RFC，并作为后续执行唯一设计真源。
...
- .legion/tasks/nvim-orgmode-norang-implementation/{plan.md,context.md,tasks.md}
- .legion/tasks/nvim-orgmode-norang-implementation/docs/rfc.md
