...
## Summary
- Verified `skills/legion-workflow/SKILL.md` exists.
- Verified `skills/legion-workflow/references/quick-checklist.md` exists.
- Verified key sections in `skills/legion-workflow/SKILL.md`: `## Source of truth`, `## Command and key matrix`, `## Standard operating flow`, `## Rollback and safety boundaries`, `## Execution boundaries for AI agents`.
